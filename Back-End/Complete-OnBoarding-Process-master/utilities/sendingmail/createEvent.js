...
<body style="margin: 0; padding: 0; font-family: sans-serif;">
  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr>
      <td style="padding: 0; background-color: #303482; color: white; font-size: 12px; border-radius: 90px 90px 0 0; text-align: center;">
        <h2 style="margin: 0; padding: 20px 0;">Congratulations! Your Event has been Created</h2>
      </td>
    </tr>
  </table>
  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: white;">
    <tr>
      <td style="padding: 20px; text-align: center;">
        <h3 style="margin: 0; font-size: 18px; text-align: center;">Congratulations! Your event has been successfully created. We're excited to have you host this event and bring your ideas to life. Here are the details:</h3>
      </td>
    </tr>
  </table>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 400px; margin: 0 auto; background-color: white; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; border-radius: 10px;">
          <tr>
            <td style="padding: 20px;">
              ...
              <p style="width: 100%; padding-left: 10px;">We can't wait to see you and your guests at the event. If you have any questions or need assistance, don't hesitate to reach out to our Adminstrators at <span style="color: rgb(7, 7, 145);">
              creativentstca@gmail.com</span> or call: <span style="color: rgb(7, 7, 145);">08067654231</span>.</p>
  ...
  <a href=${link} style="text-decoration: none; color: inherit; display: flex; justify-content: center; align-items: center;">
