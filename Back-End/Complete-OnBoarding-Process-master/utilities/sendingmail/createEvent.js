...
<body style="margin: 0; padding: 0;font-family: sans-serif;">
    <div style= "width: 100%; height: 100vh;">
        ...
        <div style="width: 100%; height: 120%; display: flex; flex-direction: column; align-items: center;">
           <h3 style="width: 60%; text-align: center;">Congratulations! Your event has been successfully created. We're excited to have you host this event and bring your ideas to life. Here are the details:
        </h3>
