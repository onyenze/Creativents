...
class Frame extends Frame_js_1.Frame {
  ...
  async waitForNavigation(options = {}) {
    ...
    Promise.all([(0, util_js_1.waitForEvent)(this.#context, waitUntilEvent, () => {
      return true;
    }, timeout, this.#abortDeferred.valueOrThrow()), (0, util_js_1.waitForEvent)(this.#context, Bidi.ChromiumBidi.BrowsingContext.EventNames.NavigationStarted, () => {
      return true;
    }, timeout, this.#abortDeferred.valueOrThrow())]), (0, util_js_1.waitForEvent)(this.#context, Bidi.ChromiumBidi.BrowsingContext.EventNames.FragmentNavigated, () => {
      return true;
