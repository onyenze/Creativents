...
class Page extends Page_js_1.Page {
  ...
  #networkManagerEvents = new Map([[NetworkManager_js_1.NetworkManagerEmittedEvents.Request, this.emit.bind(this, "request" /* PageEmittedEvents.Request */)], [NetworkManager_js_1.NetworkManagerEmittedEvents.RequestServedFromCache, this.emit.bind(this, "requestservedfromcache" /* PageEmittedEvents.RequestServedFromCache */)], [NetworkManager_js_1.NetworkManagerEmittedEvents.RequestFailed, this.emit.bind(this, "requestfailed" /* PageEmittedEvents.RequestFailed */)], [NetworkManager_js_1.NetworkManagerEmittedEvents.RequestFinished, this.emit.bind(this, "requestfinished" /* PageEmittedEvents.RequestFinished */)], [NetworkManager_js_1.NetworkManagerEmittedEvents.Response, this.emit.bind(this, "response" /* PageEmittedEvents.Response */)]]);

  #browsingContextEvents = new Map([[BrowsingContext_js_1.BrowsingContextEmittedEvents.Created, this.#onContextCreated.bind(this)], [BrowsingContext_js_1.BrowsingContextEmittedEvents.Destroyed, this.#onContextDestroyed.bind(this)]]);
  #tracing;
  #coverage;
  #cdpEmulationManager;
  #emulationManager;
  ...
  async #onFrameNavigationStarted(info) {
    ...
    if (frame) {
      ...
      await Deferred_js_1.Deferred.race([(0, util_js_1.waitForEvent)(this.#connection, 'browsingContext.domContentLoaded', predicate, 0, this.#closedDeferred.valueOrThrow()).catch(util_js_1.debugError), (0, util_js_1.waitForEvent)(this.#connection, 'browsingContext.fragmentNavigated', predicate, 0, this.#closedDeferred.valueOrThrow()).catch(util_js_1.debugError)]);
  ...
  async pdf(options = {}) {
    ...
    const {
      result
    } = await (0, util_js_1.waitWithTimeout)(this.#connection.send('browsingContext.print', {
      context: this.mainFrame()._id,
      background,
      margin,
