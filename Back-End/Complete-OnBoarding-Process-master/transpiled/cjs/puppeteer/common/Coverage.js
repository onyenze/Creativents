...
class JSCoverage {
  ...
  async start(options = {}) {
    ...
    this.#eventListeners = [(0, util_js_1.addEventListener)(this.#client, 'Debugger.scriptParsed', this.#onScriptParsed.bind(this)), (0, util_js_1.addEventListener)(this.#client, 'Runtime.executionContextsCleared', this.#onExecutionContextsCleared.bind(this))];
...
class CSSCoverage {
  ...
  async start(options = {}) {
    ...
    this.#eventListeners = [(0, util_js_1.addEventListener)(this.#client, 'CSS.styleSheetAdded', this.#onStyleSheet.bind(this)), (0, util_js_1.addEventListener)(this.#client, 'Runtime.executionContextsCleared', this.#onExecutionContextsCleared.bind(this))];
