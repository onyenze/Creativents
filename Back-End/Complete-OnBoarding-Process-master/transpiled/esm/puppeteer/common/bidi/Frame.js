...
export class Frame extends BaseFrame {
  ...
  async waitForNavigation(options = {}) {
    ...
    Promise.all([waitForEvent(this.#context, waitUntilEvent, () => {
      return true;
    }, timeout, this.#abortDeferred.valueOrThrow()), waitForEvent(this.#context, Bidi.ChromiumBidi.BrowsingContext.EventNames.NavigationStarted, () => {
      return true;
    }, timeout, this.#abortDeferred.valueOrThrow())]), waitForEvent(this.#context, Bidi.ChromiumBidi.BrowsingContext.EventNames.FragmentNavigated, () => {
      return true;
