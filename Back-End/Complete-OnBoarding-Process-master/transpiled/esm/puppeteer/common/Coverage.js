...
export class JSCoverage {
  ...
  async start(options = {}) {
    ...
    this.#eventListeners = [addEventListener(this.#client, 'Debugger.scriptParsed', this.#onScriptParsed.bind(this)), addEventListener(this.#client, 'Runtime.executionContextsCleared', this.#onExecutionContextsCleared.bind(this))];
...
export class CSSCoverage {
  ...
  async start(options = {}) {
    ...
    this.#eventListeners = [addEventListener(this.#client, 'CSS.styleSheetAdded', this.#onStyleSheet.bind(this)), addEventListener(this.#client, 'Runtime.executionContextsCleared', this.#onExecutionContextsCleared.bind(this))];
