...
export class LifecycleWatcher {
  ...
  constructor(networkManager, frame, waitUntil, timeout) {
    ...
    this.#eventListeners = [addEventListener(frame, FrameEmittedEvents.LifecycleEvent, this.#checkLifecycleComplete.bind(this)), addEventListener(frame, FrameEmittedEvents.FrameNavigatedWithinDocument, this.#navigatedWithinDocument.bind(this)), addEventListener(frame, FrameEmittedEvents.FrameNavigated, this.#navigated.bind(this)), addEventListener(frame, FrameEmittedEvents.FrameSwapped, this.#frameSwapped.bind(this)), addEventListener(frame, FrameEmittedEvents.FrameDetached, this.#onFrameDetached.bind(this)), addEventListener(networkManager, NetworkManagerEmittedEvents.Request, this.#onRequest.bind(this)), addEventListener(networkManager, NetworkManagerEmittedEvents.Response, this.#onResponse.bind(this)), addEventListener(networkManager, NetworkManagerEmittedEvents.RequestFailed, this.#onRequestFailed.bind(this))];
